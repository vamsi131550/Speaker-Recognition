...
[audio_in,audio_freq_sampl]=audioread('u1.wav');
kana = audio_in(:,1);
Length_audio=length(kana);% find the length of the audio
df=audio_freq_sampl/Length_audio;%finding the duration of the signal

frequency_audio=-audio_freq_sampl/2:df:audio_freq_sampl/2-df; 

FFT_audio_in=fftshift(fft(kana))/length(fft(kana));%fast fourier transform
...
%y=plot(frequency_audio((a):(a+1500)),b((a):(a+1500)));
c=frequency_audio((a):(a+65000)).*transpose(b((a):(a+65000)));
r=z((a):(a+1500)).*transpose(b((a):(a+1500))');
c=c(c~=0);
r=r(r~=0);
d=[c,r'];
...
if y < 200
    ...
    msgbox('Welcome kanak How may I Help You');
       defaultString = 'hai uday how may i help you';
    NET.addAssembly('System.Speech');
    obj = System.Speech.Synthesis.SpeechSynthesizer;
    obj.Volume = 100;
    Speak(obj, defaultString );
elseif y>200 && y <1200
    msgbox('Welcome dode How may I Help You');
    
   
    defaultString = 'hai durga prasad how may i help you';
    NET.addAssembly('System.Speech');
    obj = System.Speech.Synthesis.SpeechSynthesizer;
    obj.Volume = 100;
    Speak(obj, defaultString );
    ...
    msgbox('Welcome Sarath Kumar How may I Help You');
    
    defaultString = 'hai Sarath Kumar how may i help you';
    NET.addAssembly('System.Speech');
    obj = System.Speech.Synthesis.SpeechSynthesizer;
    obj.Volume = 100;
    Speak(obj, defaultString );
